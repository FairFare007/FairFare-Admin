...
import { Shield, Send, CheckCircle2, Clock, Info, AlertCircle, ArrowUpRight } from "lucide-react";
        ...
        <Layout>
            <div className="p-6 max-w-4xl mx-auto">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                    ...
                    <Link 
                        to="/my-requests"
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-slate-300 hover:text-white hover:bg-white/10 transition-all group w-fit self-start"
                    >
                        <Clock size={16} />
                        <span className="text-sm font-semibold">View Status History</span>
                        <ArrowUpRight size={14} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform text-slate-500" />
                    </Link>
                </div>
